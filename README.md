...
$\color{red}{\text{Note: the code is AI-generated using Claude Code and was not written by me.}}\\
\color{red}{\text{The code was obtained via prompting the AI to meet specific regulations that pertained to this game.}}\\
\color{red}{\text{The reason for this is because it's an Electrical Engineering course, so testing of firmware and programmability is not as valued as the actual hardware, soldering, and design process.}}$
---
